...
let handler = async (m, { conn }) => {
    const packages = [
       { type: '10HARI', price: 'Rp 5.000', urlTag: '10Hari', bonus: '' },
        ...
        { type: 'SPESIAL PAKET', price: 'Rp 50.000', urlTag: 'Spesial Paket', bonus: 'Bonus premium permanent' },
    ];
    ...
    let button = packages.map(pkg => ({
        ...
        web: [{
            text: 'Owner',
            url: `https://wa.me/6281217523837?text=Bang+Saya+Mau+Sewa+Bot+Maichan+${pkg.urlTag}`
        }]
    }));
