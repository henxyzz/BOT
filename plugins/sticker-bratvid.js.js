...
let handler = async (m, {
    ...
    try {
        ...
        for (let i = 0; i < words.length; i++) {
            ...
            const res = await (await axios.get(`https://api.betabotz.eu.org/api/maker/brat-video?text=${encodeURIComponent(currentText)}&apikey=ZenOfficial`, { responseType:  "arraybuffer" })).data;
        ...
        const stik = await createSticker(false, outputVideoPath, "By Maichan - MD", "Sewa? 6281217523837", 20)
