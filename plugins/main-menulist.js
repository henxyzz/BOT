...
*Welcome To Whatsapp Bot Nakano MD*
 Name : ${conn.user.name}
...
`.trimStart()
        ...
        if (teks == '404') {
            return await conn.textList(m.chat, listCmd, fs.readFileSync('./media/thumbnail.jpg'), lists, m, { mentions: [m.sender] })
        }
        ...
        await conn.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            title: "",
                            body: 'MenuList Nakano',
                            thumbnailUrl: "https://files.catbox.moe/eb8z4j.jpgpg",
                            sourceUrl: null,
                            mediaType: 1,
